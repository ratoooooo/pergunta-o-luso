...
import com.starforge.app.data.ModeStats
...
import com.starforge.app.ui.theme.LevelPill
...
fun RankingScreen(
    ...
    com.starforge.app.game.MainScaffold(
        active = com.starforge.app.ui.theme.NavTab.RANKING,
        onHome = onHome,
        onRanking = {},
        onFriends = onFriends,
        onProfile = onProfile
